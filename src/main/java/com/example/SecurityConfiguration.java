...
import com.example.jwt_configuration.CustomHttpStatusEntryPoint;
...
public class SecurityConfiguration {
    ...
    private final CustomHttpStatusEntryPoint customHttpStatusEntryPoint;
    @Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                .exceptionHandling(customizer -> customizer
                        .authenticationEntryPoint(customHttpStatusEntryPoint))
                .build();
    }
}
